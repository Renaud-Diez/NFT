...
$this->versionMenu=array(
	...
	//array('label'=>'Create Milestone', 'url'=>'#', 'linkOptions'=>array('onclick'=>';dialogJS("/index.php/project/setmilestone/id/'.$model->id.'", "dialogSetmilestone");$("#dialogSetmilestone").dialog("open"); return false;')),
	//array('label'=>'Create Milestone', 'url'=>'#', 'linkOptions'=>array('onclick'=>';dialogJS("/index.php/milestone/create/pid/'.$model->id.'", "dialogSetmilestone");$("#dialogSetmilestone").dialog("open"); return false;')),
