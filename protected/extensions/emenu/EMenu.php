...
class EMenu extends YiiSmartMenu//CMenu
{
    ...
    public function init()
    {
        ...
        elseif($this->linear) //dropdown dropdown-linear dropdown-columnar
        {
        	$class[] = 'dropdown-linear dropdown-columnar';
            $cssFile = 'themes/lwis.celebrity/default.advanced.css';
        }
        else{
...
//                    $class[]=$this->activeCssClass;
            ...
            if(isset($item['items']) && count($item['items']))
                if(empty($options['class']))
                    $options['class'] = $this->dirCssClass;//$options['class']=' '.$this->dirCssClass;
                else
