			    ...
			    'items'=>array(
			        array(
			            ...
			            'items'=>array(
			                ...
			                array('label'=>'Issues', 'url'=> array('/issue'), 'visible' => Yii::app()->user->checkAccess('Issue.View')? true: false, 'items'=>array(
			                	array('label'=>'DEFINITION', 'visible' => Yii::app()->user->checkAccess('Issue.Admin')? true: false),
			                	array('label'=>'Issue Type', 'url'=> array('/IssueType'), 'visible' => Yii::app()->user->checkAccess('Issuetype.Admin')? true: false),
			                	array('label'=>'Issue Status', 'url'=> array('/IssueStatus'), 'visible' => Yii::app()->user->checkAccess('Issuestatus.Admin')? true: false),
			                	'---',
			                	array('label' => 'VIEW'),
			                	array('label'=>'All Issues', 'url'=> array('/Issue/index')),
			                	array('label'=>'My Issues', 'url'=>array('/user/view')),
			                	array('label'=>'My GTD', 'url'=>array('/user/gtd')),
			                	'---',
			                	array('label'=>'CONFIGURATION', 'visible' => Yii::app()->user->checkAccess('Issue.Admin')? true: false),
			                	array('label'=>'Issue Type by Topic', 'url'=> array('/IssueType/typetopic'), 'visible' => Yii::app()->user->checkAccess('Issue.Admin')? true: false),
			                	array('label'=>'Issue Type by Role', 'url'=> array('/IssueType/typerole'), 'visible' => Yii::app()->user->checkAccess('Issue.Admin')? true: false),
			                	array('label'=>'Issue Status by Type', 'url'=> array('/IssueType/typestatus'), 'visible' => Yii::app()->user->checkAccess('Issue.Admin')? true: false),
			                )),
			                array('label'=>'Projects', 'url'=>'#', 'authItemName' => 'Project.View', 'visible' => Yii::app()->user->checkAccess('Project.*')? true: false, 'active'=>$activeProject,  'items'=>array(
			                    ...
			                    '---',
			                    array('label'=>'CONFIGURATION', 'visible' => Yii::app()->user->checkAccess('Project.Admin')? true: false),
			                    array('label'=>'Project Topics', 'url'=>array('/topic'), 'visible' => Yii::app()->user->checkAccess('Project.Admin')? true: false),
			                    array('label'=>'Project Status', 'url'=>array('/ProjectStatus'), 'visible' => Yii::app()->user->checkAccess('Project.Admin')? true: false),
			                    array('label'=>'Project Status by Topic', 'url'=>array('/ProjectStatus/statustopic'), 'visible' => Yii::app()->user->checkAccess('Project.Admin')? true: false),
			                )),
			                array('label'=>'Users', 'url'=> array('/admin/user'), 'authItemName' => 'User.View', 'visible' => Yii::app()->user->checkAccess('User.view')? true: false, 'active'=>$activeUser,  'items'=>array(
			                	array('label'=>'New User', 'url'=>array('/admin/user/create'), 'visible' => Yii::app()->user->checkAccess('User.Create')? true: false),
			                	'---',
			                	array('label'=>'VIEWS'),
			                	array('label'=>'User List', 'url'=>array('/admin/user'), 'visible' => Yii::app()->user->checkAccess('User.Admin')? true: false),
			                	array('label'=>'User Activities', 'url'=>array('/user/whosOnWhat'), 'visible' => Yii::app()->user->checkAccess('User.Whosonwhat')? true: false),
			                	'---',
			                	array('label'=>'TEAM'),
			                	array('label'=>'Team List', 'url'=>array('/team'), 'visible' => Yii::app()->user->checkAccess('Team.Index')? true: false),
			                	'---',
			                    array('label'=>'TIME TRACKING'),
			                    array('label' => 'Create a new Activity', 'url' => array('/TimeActivity/create'), 'visible' => Yii::app()->user->checkAccess('TimeActivity.*')? true: false),
			                    array('label' => 'Time Tracking Activities', 'url' => array('/TimeActivity'), 'visible' => Yii::app()->user->checkAccess('TimeActivity.*')? true: false),
			                )),
